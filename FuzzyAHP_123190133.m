function [bobotAntarKriteria, relasiAntarKriteria] = FuzzyAHP_123190133(relasiAntarKriteria, TFN)
    fuzzyRelasi = {};
    ...
    %yaitu dengan cara membagi masing-masing nilai bobot dengantotal semua bobot
